...
If a PagerDuty incident is created from the critical trigger of a metric alert and has no warning threshold, it will resolve itself when the Sentry metric alert is resolved.
